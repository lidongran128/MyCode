...
import java.util.Comparator;//强行对某个对象 collection 进行整体排序 的比较函数
...
//定义异步处理类
	...
	ArrayList<Object> accounts = new ArrayList<Object>();	//多个账户
	List<AccountData> listSort = new ArrayList<AccountData>();// 对账户排序

	@Override
	protected Void doInBackground(SettingAccountActivity... params) {//后台运行耗时操作,...是？？？？？
